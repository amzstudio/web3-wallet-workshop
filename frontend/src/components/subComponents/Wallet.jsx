        ...
        {(() => {
            ...
            if(posts["tokenBalances"] === undefined){
                ...
                return posts["tokenBalances"].map((cryptObj,index) => <>
                      ...
                      onClick={() => navigate('/TransactionStatus',{state:{crypto:cryptObj["tokenIdentifier"]["network"].replace('_MAINNET',''), value :cryptObj["tokenIdentifier"]["tokenId"]==="eth" ? Web3.utils.fromWei(cryptObj["balance"],'ether'): cryptObj["balance"],user_name:user_name,address:cryptObj["ownerIdentifier"]["address"]}})}
                      ></div>
                      ...
                      onClick={() => navigate('/TransactionStatus',{state:{crypto:cryptObj["tokenIdentifier"]["network"].replace('_MAINNET',''), value :cryptObj["tokenIdentifier"]["tokenId"]==="eth" ? Web3.utils.fromWei(cryptObj["balance"],'ether'): cryptObj["balance"],user_name:user_name,address:cryptObj["ownerIdentifier"]["address"]}})}
                      >
                        {cryptObj["tokenIdentifier"]["tokenId"]==="eth" ? Web3.utils.fromWei(cryptObj["balance"],'ether'): cryptObj["balance"]}
