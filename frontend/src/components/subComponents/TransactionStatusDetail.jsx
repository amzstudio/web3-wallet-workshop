        ...
        {(() => {
            ...
            if(posts["transaction"] === undefined){
               ...
               */}      
                ...
                <span style={{top:'390px'}} class="crypto_trxdetail_value1">{crypto_name==='BITCOIN' ? posts["transaction"]["transactionFee"] : Web3.utils.fromWei(posts["transaction"]["effectiveGasPrice"],'ether')}</span>
                ...
                { 
                  ...
                  <span style={{top:top+30+'px'}} class="event_val">Amount :  {cryptObj["eventType"]==="ETH_TRANSFER" ? Web3.utils.fromWei(cryptObj["value"],'ether') : cryptObj["value"]}  </span>
